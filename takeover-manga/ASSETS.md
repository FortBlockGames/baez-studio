...
| **Gus Fenner — manga (original cast, ch.2+)** | `Gus-Fenner-Manga` | `dc10104f-1311-4b1a-ae67-7befad4b715c` | ✅ CUT (founder-approved anchor, job `1153af96`, 2026-07-24). Recurring Arc 1 cast. Merica City native, late 50s, ex-citizen-pilot, indebted to the Chickows credit line. **Invariants:** heavy weathered build, close-cropped grey hair + stubble, utility shirt + open long dust coat + canvas trousers + scuffed boots. **Mutation mark (Merica City Incident):** dark keratinous feather-grained plating up the LEFT jaw/neck/hairline; LEFT eye horizontal slit pupil; LEFT hand plated across the knuckles and permanently half-closed — fingers never fully open. Matter-of-fact, never grotesque. **ALWAYS pure monochrome — no spot color on skin or plating.** |
